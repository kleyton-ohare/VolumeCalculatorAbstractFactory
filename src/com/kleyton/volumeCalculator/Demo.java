...
import com.kleyton.volumeCalculator.provider.FactoryProvider;
			...
			submit.addActionListener(new ActionListener() {				
				public void actionPerformed(ActionEvent e) {
					...
					if(sphere.isSelected()) {
						shape = FactoryProvider.getShape(new SphereFactory(value));
					} else if (cube.isSelected()) {
						shape = FactoryProvider.getShape(new CubeFactory(value));
					} else if (tetrahedron.isSelected()) {
						shape = FactoryProvider.getShape(new TetrahedronFactory(value));					
					}
